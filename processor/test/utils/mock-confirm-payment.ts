import { MonextSessionDetails } from '../../src/clients/types/monext.client.type';
import { Payment } from '@commercetools/connect-payments-sdk';

export const monextSessionCaptureResult: MonextSessionDetails = {
  result: {
    title: 'ACCEPTED',
    code: '00000',
...
export const validPaymentResult: Payment = {
